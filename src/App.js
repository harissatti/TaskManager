...
function App() {
  ...
  const initConnection = async () => {
    if (typeof window.ethereum !== "undefined") {
      ...
      setContract(new ethers.Contract("0x5FbDB2315678afecb367f032d93F642f64180aa3",
        Manager.abi,
        newSigner));
  ...
  return <div className="page">
    <div className="header">
      <p>TaskManager</p>
      {account != "" ? <p>{account.substring(0, 9)}</p> :
        <button className="big_button" onClick={initConnection}>Connect</button>}
    </div>
          ...
          return(
            <div key={index} className="main_ticket_card">
              ...
              <div className="main_ticket_button_section">
                ...
                onClick={()=>updateTicketStatus(ticket.id,1)}>Busy
                </button>
                <button 
                 className="small_button"
